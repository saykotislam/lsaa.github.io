...
function showResult() {
    ...
    if (totalScore >= 145) {
        ...
        if (optionLessThan6) {
            ...
            quizContainer.innerHTML = ` প্রিয় ${userName} , তোমার মাঝে অফুরন্ত সম্ভাবনা রয়েছে।কিন্তু তোমার দেওয়া উত্তরগুলোতে কিছু  অসামঞ্জস্যতা পরিলক্ষিত হচ্ছে। তুমি এই এসেসমেন্ট সিটগুলো পুনরায় পূরণ কর।আমরা তোমাকে সহযোগিতা করতে চাইছি তবে আমাদের দেওয়া প্রশ্নগুলোর উত্তর দেওয়ার সময় তুমি নিজের অন্তরে উপস্থিত হওয়া প্রথম অনুভুতিটি দিয়ে পুনরায় উত্তর দাও। তুমি শুধু প্রশ্নগুলো পড়বে আর নিজের জন্য সবথেকে সত্য মনে হওয়া উত্তরটি বেছে নিবে। মনে রেখ, এখানে সঠিক কিংবা ভুল উত্তর বলে কিছু নেই, তুমি শুধু সততার সাথে আপন মনের প্রথম অনুভূতি থেকে উত্তরগুলো বেছে নেবে। 
            <button onclick="location.reload() class="dbtn"">Restart</button>`;
        } else {
            // Display message with download button
            let advice = '';
            if (userAnswers[0] === 3) {
                advice += "\nপ্রতিদিন অন্তত কয়েক পৃষ্ঠা যে কোন ধরণের বই পড়ার অভ্যাস করতে হবে তোমাকে। ";
            }
            if (userAnswers[1] >= 1) {
                advice += "\nপ্রতিদিন অন্তত এক ঘণ্টা শারীরিকভাবে পরিশ্রমী ও ঘাম ঝরানোর মত যে কোন কাজ কিংবা ব্যায়াম করবে। ";
            }
            if (userAnswers[4] === 1) {
                advice += "\nতোমার মাঝে ডিজিটাল এডিকশনের প্রকট আশংকা রয়েছে, তাই শুধুমাত্র বিশেষ প্রয়োজন ব্যতিত ইন্টারনেটের ব্যবহার হতে দূরে থাকবে। ";
            }
            if (userAnswers[5] === 3) {
                advice += "\nদিনের অনেকটা সময় অযথায় কাটিয়ে দেওয়ার অভ্যাস রয়েছে তোমার মাঝে; সময়কে আরও ভালোভাবে ব্যবহার করার অভ্যাস করবে। ";
            }
            if (userAnswers[6] <= 1) {
                advice += "\nউচ্চতাভীতি ও পানিভীতি দূর করতে ভয়ের কাজটিই নিয়মিত চেষ্টা করতে হবে তোমায়। ভীতিকর কাজটিকে এত বেশি চর্চা করবে যেন তা তোমার দৈনিন্দন সাধারণ কাজের অংশ হয়ে যায়, তাহলে সহজেই তুমি ভয়কে জয় করে আরও আত্মবিশ্বাসী হতে পারবে। ";
            }
            if (userAnswers[8] >= 1) {
                advice += "\nনিজের দেশ ও সমাজের বিষয়ে অনেকের মত তোমার মাঝেও কিছুটা হীনমন্যতা রয়েছে যা হতে তোমার উত্তরণ দরকার। ভেবে দেখ, এদেশের অধিকাংশ মানুষই গরীব অথচ তারা সৎ, পরিশ্রমী, সহযোগী আর বন্ধুত্বপূর্ণ। এই দেশের প্রতি, এই মানুষদের প্রতি দায়িত্ব রয়েছে তোমার তাই মাঝে মাঝে গ্রামের মানুষের কাছে বেড়াতে যাও, দেশকে দেখ, দেশের ইতিহাসকে জানার চেষ্টা করো। ";
            }
            if (userAnswers[10] >= 1) {
                advice += "\nএস এস সি ও এইচ এস সি পরীক্ষায় জিপিএ ৫ গ্রেড পাওয়ার জন্য সর্বোচ্চ পরিশ্রমে লেগে থাকতে হবে তোমায়। মনে রেখ, ভালো গ্রেডই তোমার পরিশ্রম করার মাপকাঠি আর ছাত্র জীবনে তোমার সম্মানের পরিচয়। ";
            }
            if (userAnswers[11] >= 1) {
                advice += "\nবন্ধুদের কাজে আরও বেশি সহযোগী হও এবং তাদের সাথে আন্তরিক সম্পর্ক গড়ে তোলার কৌশল আয়ত্ব করতে চেষ্টা কর। তাদের সাথে বিতর্ক না করে তাদের মতামতকে সম্মান কর। সব সময় সঠিক কথা বলে নিজের জ্ঞান প্রচার করার চেয়ে তাদের সাথে সম্পর্ক গড়া ও সে সম্পর্ক রক্ষা করা অনেক লাভজনক। ";
            }
            if (userAnswers[12] >= 1) {
                advice += "\nকোন একক কাজে গভীর মনোযোগ নিবদ্ধ করার কিছু বাস্তব ধর্মী ট্রেনিং নাও এবং সম্ভব হলে প্রতিদিন ২/৩ বার কয়েক মিনিটের জন্য মেডিটেশন চর্চা কর। ";
            }
            if (userAnswers[13] >= 1) {
                advice += "\nমানুষকে তাদের কাজে যথাসম্ভব সাহায্য করার অভ্যাস করো; কেও না চাইলে নিজের মতামত দেওয়া থেকে বিরত থাকো। মতামত দেওয়ার ক্ষেত্রে সংক্ষেপে, অল্প কথায় যৌক্তিকভাবে এবং ধীরস্থির ভাবে কথা বলার অভ্যাস রপ্ত করবে। ";
            }
            if (userAnswers[15] >= 1) {
                advice += "\nমানুষকে তাদের কাজে যথাসম্ভব সাহায্য করার অভ্যাস করো; কেও না চাইলে নিজের মতামত দেওয়া থেকে বিরত থাকো। মতামত দেওয়ার ক্ষেত্রে সংক্ষেপে, অল্প কথায় যৌক্তিকভাবে এবং ধীরস্থির ভাবে কথা বলার অভ্যাস রপ্ত করবে। ";
            }
            if (userAnswers[20] === 1) {
                advice += "\nবাবা-মায়ের অর্থ দিয়ে শখ পূরণ করা তোমার আত্ম সম্মানের জন্য ক্ষতিকর, তাই শুধু শুধুমাত্র প্রয়োজনীয় কাজে অর্থ খরচের চেষ্টা করবে। অপচয় রোধ করার অভ্যাস করবে। শখ পূরণের জন্য নিজে উপার্জন করা পর্যন্ত অপেক্ষা কর, সেটাই তোমার মূল্যবোধের অংশ হওয়া উচিত। ";
            }
            if (userAnswers[21] >= 1) {
                advice += "\nসংক্ষেপে এবং শুধু অর্থপূর্ণ কথা বলার অভ্যাস করবে। যা কিছু তোমার জানা নাই সে বিষয়ে চুপ থাকবে। আয়নার সামনে দাঁড়িয়ে নিজের প্রতিবিম্বের চোখের দিকে তাকিয়ে নিজের সাথে নিজেই কথা বলার অনুশীলন করবে; এইভাবে কোন একটা বিষয়ে নিজের মতামত উপস্থাপনের চর্চা তোমাকে বেশি আত্মবিশ্বাসী হতে সাহায্য করবে। ";
            }
            if (userAnswers[23] >= 1) {
                advice += "\nনিজের বাড়িতে এবং সমমনা বন্ধুদের সাথে ইংরেজিতে কথা বলার চর্চা করবে । প্রথমে ভুল হবে কিন্তু তা বলে লজ্জা পেয়ে চর্চা বন্ধ করবে না। সম্ভব হলে কোন একটা বিষয়ের উপর ইংরেজিতে বক্তব্য দিবে আর সেটিকে রেকর্ড করে নিজেই নিজের দুর্বলতাগুলো চিহ্নিত করবে, এবং পুনরায় অনুশীলন করবে। ইংরেজি ভাষায় যে সব ডকুমেন্টারি কিংবা নিউজ রয়েছে তা শুনবে এবং দেখবে। ";
            }
            if (userAnswers[29] >= 1) {
                advice += "\nরাত ১০ টার মাঝেই ঘুমিয়ে যাওয়া আর ভোর ৫ টার মাঝে জেগে উঠে দিন শুরু করার অভ্যাস করবে। প্রয়োজনে দুপুরে একটু ঘুমিয়ে নিবে। ";
            }
...
function downloadPDF() {
    ...
    // Create a copy of the element to remove the download PDF button
    ...
    elementCopy.appendChild(headerDiv);
